<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">		
                    ...
                    <li><a class="has-arrow ai-icon" href="java61script:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="java61script:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{ route('all.services') }}">All Images</a></li>
							<li><a href="{{ route('add.services') }}">Add Images</a></li>
						</ul>
				...
				<div class="copyright">
					<p><strong>Luka Kirinčić Admin Dashboard</strong> © 2024 All Rights Reserved</p>
				</div>
			</div>
        </div>